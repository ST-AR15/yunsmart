<template>
  <div class="szaf-home">
    <div id="C1" class="szaf-home-item"></div>
    <div id="C2" class="szaf-home-item"></div>
    <div id="C3" class="szaf-home-item"></div>
    <div id="C4" class="szaf-home-item"></div>
    <div id="C5" class="szaf-home-item"></div>
    <div id="C6" class="szaf-home-item"></div>
  </div>
</template>
